...
import com.mr208.unwired.common.crafting.RecipeFluidHelper;
...
public class FluidIngredient implements Predicate<FluidStack>
{
	...
	private static final Predicate<? super FluidIngredient.IFluidList> IS_EMPTY = fluidList -> {
	...
	private final FluidIngredient.IFluidList[] acceptedFluids;
	...
	protected FluidIngredient(Stream<? extends FluidIngredient.IFluidList> fluidLists)
	{
		this.acceptedFluids = fluidLists.filter(IS_EMPTY).toArray((index) ->
		{
			return new FluidIngredient.IFluidList[index];
		});
	...
	public static FluidIngredient fromFluidListStream(Stream<? extends FluidIngredient.IFluidList> stream)
	{
	...
	public JsonElement serialize()
	{
		...
		else
		{
			...
			FluidIngredient.IFluidList[] fluids = this.acceptedFluids;
	...
	public static FluidIngredient.IFluidList deserializeFluidList(JsonObject json)
	{
